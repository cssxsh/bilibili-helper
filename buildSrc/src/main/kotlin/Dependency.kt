...
fun DependencyHandler.selenium(module: String, version: String) = "org.seleniumhq.selenium:selenium-$module:$version"

fun DependencyHandler.junit(module: String, version: String) = "org.junit.jupiter:junit-jupiter-${module}:${version}"

fun DependencyHandler.mxlib(module: String, version: String) = "io.github.karlatemp.mxlib:mxlib-$module:${version}"